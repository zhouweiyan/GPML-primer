...
clc
load array2.txt
array_offset=floor(mean(array2));
array=array2-array_offset;
array=reshape(array,256,256);
figure
...
% covfunc={'covMaternard',3};hyp.cov=log([4;2;3]);%9e3
covfunc={'covPER','ard',{'covSEiso'}};hyp.cov=log([500;20;3;6]);
