...
fileID = fopen('E:\OneDrive - hnu.edu.cn\tools\matlabcourse\GPML_matlab\GPML-primer\reconstruction\GP_AFM_paper\delta_PSNR\RMS_array2_spiral.txt','a');
fprintf(fileID, '%8f\n', RMS);
fclose(fileID);